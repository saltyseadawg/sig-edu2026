...
%   \centering
%   \begin{tabular}{lccc}
%     \foreignlanguage{tamil}{பெரியவர்களுடனா}\\
%     \foreignlanguage{tamil}{பெரியவர்} & \foreignlanguage{tamil}{கள்} & \foreignlanguage{tamil}{ுடன்} & \foreignlanguage{tamil}{ா} \\
%     periyavar & kaḷ & uṭan & a:\\
%     elder & plural & with & interrogative \\
...
For instance, the input \foreignlanguage{tamil}{பூதங்கள்} boothangaL ‘ghosts’ would match to the 
suffix \foreignlanguage{tamil}{ங்கள்} ngaL, as shown in Figure. \textit{gloss} is a layman’s definition of this suffix.
...
For example, the plural suffix \foreignlanguage{tamil}{கள்} gaL can also also appear as \foreignlanguage{tamil}{க்கள்} kkaL or 
\foreignlanguage{tamil}{ங்கள்} ngaL based on the sound it is preceded by, but since \foreignlanguage{tamil}{கள்} is its 
...
the valid lemma \foreignlanguage{tamil}{பூதம்} bootham (‘ghost’). 
