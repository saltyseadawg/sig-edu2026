...
computational linguistics \citep{noauthor_natural_nodate}.
...
\begin{enumerate}
  \item Find the meaning of பெரியவர்களுக்கு using the prototype interface. Try entering the word using Tamglish\footnote{Colloquial term used to refer to the code-mixing of Tamil and English in casual speech.} / English letters.
  \item Find the meaning of அறிந்துகொண்டேன் but type the word in Tamil.
  \item Find the meaning of பெருகிவிட்டால் but use your voice. 
  \item Find the meaning of சிதறிவிடும் using your preferred input method from the previous tasks.
\end{enumerate}
\end{document}
