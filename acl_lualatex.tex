...
See (\ref{ex:elders}), where a complete utterance is expressed as one word. \\
\begin{example}
  \expreamble{\foreignlanguage{tamil}{பெரியவர்களுடனா}}
  \digloss{\foreignlanguage{tamil}{பெரியவர்} \foreignlanguage{tamil}{கள்} \foreignlanguage{tamil}{ுடன்} \foreignlanguage{tamil}{ா}}
    {periyavar kaḷ uṭan a:}
    {\textit{with the elders?}}
  \label{ex:elders}
\end{example}
...
any suffix included in the Gramble JSON file. If there are multiple matches, 
