...
matched against as described in the systems design (\ref{sec:systems-design}). 
For instance, the input \foreignlanguage{tamil}{பூதங்கள்} \textit{boothangaL} ‘ghosts’ would match to the 
suffix \foreignlanguage{tamil}{ங்கள்} \textit{ngaL}, as shown in Figure \ref{fig:ui-puthamkal}. \textit{gloss} is a layman's definition of this suffix.
\begin{figure}[t]
...
\foreignlanguage{tamil}{ங்கள்} \textit{ngaL} based on the sound it is preceded by, but since \foreignlanguage{tamil}{கள்} is its 
...
\begin{table}
  \begin{tabular}{c|c|c}
    ...
    Total & \textbf{20} & \\
  \end{tabular}
  \caption{Unconjugated (input=lemma)}
...
\begin{table}
  \begin{tabular}{c|c|c}
    ...
    total & \textbf{260} & \\
  \end{tabular}
  \caption{Conjugated (input=lemma)}
...
\begin{table}
  \begin{tabular}{c|c|c}
    ...
    Total & \textbf{89} & \\
  \end{tabular}
  \caption{Input returns no result for conjugated (input=lemma)}
  \label{tab:no-result}
\end{table}
...
\begin{table}
  \begin{tabular}{c|c|c}
    ...
    total & \textbf{45} & \\
  \end{tabular}
  \caption{Output is incorrect for conjugated (input=lemma)}
